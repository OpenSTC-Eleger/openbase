...
##Base implementation of recurrence used for OpenSTC modules
##To use it with models, you can use inheritance : 
##    * 1- create a new model inheriting of this one (using _inherit)
##    * 2- override occurrence_ids to use a one2many on an existing model of your choice
##    * 3- override method 'prepare_occurrences' to customize data to be written on the 'occurence_ids' records
##    * 4- optionally, use _defaults attribute on your inheriting object to simplify setting of recurrence
##
##Or you can use this object directly (you'll use the objects defined here directly instead of custom ones): 
##    * 1- put a many2one to you're own object relating to this model
##    * 2- when generating occurrences, records will be created using openbase.recurrence.occurrence objects
##
...
##Occurrence generated by default by openbase.recurrence
##for custom purpose, you can redefine the 'occurrence_ids' field of openbase.recurrence to use your custom object instead of this one 
